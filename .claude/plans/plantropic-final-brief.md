...
| 3 | Supabase setup + Auth + schema + RLS, sambungin login/register | Supabase, @supabase/ssr | 🟡 KODE SIAP — tinggal user jalanin `supabase/migrations/0001_init.sql` di SQL Editor + cek setting email auth |
